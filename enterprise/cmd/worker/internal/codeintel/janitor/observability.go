...
func newMetrics(observationContext *observation.Context) *metrics {
	...
	numUploadResetErrors := counter(
		"src_codeintel_background_upload_resets_errors_total",
	...
	numIndexResetErrors := counter(
		"src_codeintel_background_index_resets_errors_total",
	...
	numDependencyIndexResetErrors := counter(
		"src_codeintel_background_dependency_index_resets_errors_total",
